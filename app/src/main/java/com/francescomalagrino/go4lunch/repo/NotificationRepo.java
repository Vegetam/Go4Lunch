...
import com.francescomalagrino.go4lunch.view.SplashLunchActivity;
...
class NotificationRepo extends FirebaseMessagingService {
                ...
                RestaurantHelper.getRestaurant(restoTodayId).addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                    ...
                    public void onSuccess(DocumentSnapshot documentSnapshot) {
                        ...
                        for (int i=0; i<listUserId.size(); i++) {
                            UserRepository.getUser(listUserId.get(i)).addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                                @Override
                                public void onSuccess(DocumentSnapshot documentSnapshot) {
                                    User user = documentSnapshot.toObject(User.class);
                                    String name = null;
