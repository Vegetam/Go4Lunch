...
import com.francescomalagrino.go4lunch.repo.ListOfRestaurantDetailAdapter;
...
import com.francescomalagrino.go4lunch.utils.RestaurantRate;
...
public class RestaurantDetailActivity extends AppCompatActivity {
    ...
    private void updateLikeInFirebase(final String idResto) {
        ...
        UserRepository.getUser(userId).addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            @Override
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                if (documentSnapshot.exists()) {
                    ...
                    UserRepository.updateLikedRestaurant(listRestoLike, userId);
                }
            }
        });
    }
    ...
    private void updateRestoInUser(String id, String name, String date ) {
        UserRepository.updateTodayRestaurant(id, userId);
        UserRepository.updateTodayRestaurantName(name, userId);
        UserRepository.updateRestaurantDate(date, userId);
    }
